...
public class GroupMemberIngestor {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				eventProperties.put(header[6], splits[6]);
				eventProperties.put(header[7], splits[7]);

				Event projectTakenEvent = new Event().event("memberOf")
				...
				Futures.addCallback(future.getAPIResponse(),
						getFutureCallback("user " + uid + " member of " + gid));
